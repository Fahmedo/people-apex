              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-white/80">
                      We continuously seek new and better ways to serve our
                      clients.
                    </p>
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-white/80">
                      We enable organizations and individuals to reach their
                      full potential.
                    </p>
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-white/80">
                      We work together with our clients to achieve shared goals.
                    </p>
                  </div>
                </li>
              </ul>
